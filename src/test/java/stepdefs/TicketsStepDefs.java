...
public class TicketsStepDefs {
    ...
    public void check_success_msg() {
        Assertions.assertEquals("Thank You for flying with us!", successPage.getMessage(), "Can`t fint success message!");
    }
}
